...
module.exports = function(angular) {
    ...
    angular.module.commonModule = commonModule = angular.module("commonModule", ["ngRoute", "ngSanitize", "ngResource", "designModule"])
    ...
    require('./controllers')(angular, commonModule);
